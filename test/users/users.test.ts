...
describe('users and auth endpoints', () => {
  ...
  describe('with a valid access token - disallow tests', () => {
    ...
    it('should disallow a PUT to /users/:userId/permissionFlags/2 by non-admin', async () => {
      const res = await request
  ...
  describe('with a valid access token - allow tests', () => {
