...
let firstUserIdTest = '';
const firstUserBody = {
    email: `Timothy.utkin+${shortid.generate()}@gmail.com`,
...
const newFirstName2 = 'Ivan';
const newLastName2 = 'Sasha';
...
describe('users and auth endpoints', function () {
    ...
    describe('with a valid access token - disallow tests', function () {
        ...
        it('should disallow a PUT to /users/:userId/permissionFlags/2 by non-admin', async function () {
            const res = await request
    ...
    describe('with a valid access token - allow tests', function () {
